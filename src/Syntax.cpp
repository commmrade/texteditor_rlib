...
const std::unordered_map<std::string, std::unordered_map<std::string, Color>> SyntaxHighlight::lang_keywords = {
    {"cpp", {
        // Data types
        {"int", BLUE},
        {"float", BLUE},
...
std::vector<Token> SyntaxHighlight::parse_line(const std::vector<std::string> &words, std::string lang = "") {
